...
| **HandoffReady**                    | Department routes, multi-task plans, per-task owner or queue assignment, Super Admin setup, and one-object encrypted settings    | [Product guide](projects/handoffready/README.md)          |
