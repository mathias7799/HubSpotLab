...
| **HandoffReady**                    | Department routes, multi-task plans, output ownership, reminders, person/queue assignment, and one-object encrypted settings     | [Product guide](projects/handoffready/README.md)          |
